...
const (
	...
	InvApplyPreservesOrder     = "INV-27"
	InvApplyIdempotent         = "INV-28"
	InvAndIsIntersection       = "INV-30"
	InvOrIsUnion               = "INV-31"
	InvNotIsComplement         = "INV-32"
	InvEmptyAndMatchesAll      = "INV-33"
	InvAndOrCommutative        = "INV-34"
	InvDeMorgan                = "INV-35"
	InvTermRoundTrip           = "INV-36"
	InvTermParseTotal          = "INV-37"
	InvNegatedOpIsComplement   = "INV-38"
	InvExactSelfMatch          = "INV-39"
	InvSubstringSelfMatch      = "INV-40"
	InvGlobSelfMatch           = "INV-41"
	InvSentinelNeverMatches    = "INV-42"
	InvSubstringCaseInsens     = "INV-43"
	InvSearchEqualsFilter      = "INV-44"
